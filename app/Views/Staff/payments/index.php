...
<head>
    ...
    <title>Manage Payments - Hotel Management System</title>
...
<body>
    ...
    <div class="main-content">
        <div class="page-header">
            ...
            <a href="<?= base_url('staff/payments/create') ?>" class="btn btn-primary">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <div class="stat-value pending"><?= $stats['status']['pending']['count'] ?? 0 ?></div>
                <div class="stat-label">Pending Payments</div>
            </div>
            <div class="stat-card">
                <div class="stat-icon completed"><i class="fas fa-check-circle"></i></div>
                <div class="stat-value completed"><?= $stats['status']['completed']['count'] ?? 0 ?></div>
                <div class="stat-label">Completed Payments</div>
            </div>
            <div class="stat-card">
                <div class="stat-icon failed"><i class="fas fa-times-circle"></i></div>
                <div class="stat-value failed"><?= $stats['status']['failed']['count'] ?? 0 ?></div>
                <div class="stat-label">Failed Payments</div>
            </div>
            <div class="stat-card">
                <div class="stat-icon completed"><i class="fas fa-dollar-sign"></i></div>
                <div class="stat-value completed">$<?= number_format($stats['status']['completed']['amount'] ?? 0, 2) ?></div>
        ...
        <div class="filters-card">
            <form method="GET" action="<?= base_url('staff/payments') ?>">
                <div class="filters-row">
                    <div class="form-group">
                        <label for="search" class="form-label">Search</label>
                        <input type="text" class="form-control" id="search" name="search" 
                               value="<?= esc($search) ?>" placeholder="Search by payment ID, amount...">
                    </div>
                    <div class="form-group">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <?php foreach ($payments as $payment): ?>
                                <tr>
                                    <td>
                                        <span class="code">#<?= $payment['payment_id'] ?></span>
                                    </td>
                                    <td>
                                        <span class="code">#<?= $payment['reservation_id'] ?></span>
                                    </td>
                                    <td>
                                        Room <?= esc($payment['room_number']) ?>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="<?= base_url('staff/payments/view/' . $payment['payment_id']) ?>" 
                                               class="btn btn-info btn-sm" title="View Details">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <?php if ($status == 'failed'): ?>
                                                <a href="<?= base_url('staff/payments/retry/' . $payment['payment_id']) ?>" 
                                                   class="btn btn-warning btn-sm" title="Retry Payment">

...
<head>
    ...
    <title>Manage Reservations - Hotel Management System</title>
...
<body>
    ...
    <div class="main-content">
        <div class="page-header">
            ...
            <a href="<?= base_url('staff/reservations/create') ?>" class="btn btn-primary">
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                ...
                <div class="stat-value cancelled"><?= $stats['cancelled']['count'] ?? 0 ?></div>
        ...
        <div class="filters-card">
            <form method="GET" action="<?= base_url('staff/reservations') ?>">
                <div class="filters-row">
                    <div class="form-group">
                        <label for="search" class="form-label">Search</label>
                        <input type="text" class="form-control" id="search" name="search" 
                               value="<?= esc($search) ?>" placeholder="Search by name, ticket, room...">
                    </div>
                    <div class="form-group">
        ...
        <!-- Reservations Table -->
        <div class="reservations-table-card">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <?php foreach ($reservations as $reservation): ?>
                                <tr>
                                    <td>
                                        <span class="code">#<?= $reservation['reservation_id'] ?></span>
                                    </td>
                                    <td>

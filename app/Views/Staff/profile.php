...
<body>
    ...
    <div class="main-content">
        <div class="page-header">
            ...
            <a href="<?= base_url('staff/dashboard') ?>" class="btn btn-secondary">
            ...
            <div class="profile-card">
                ...
                <div class="card-body">
                    <div class="profile-info">
                        ...
                        <div class="profile-name"><?= esc($staff['full_name']) ?></div>
                        <div class="profile-role"><?= ucfirst(esc($staff['role'])) ?></div>
                        <div class="profile-hotel"><?= esc($staff['hotel_name']) ?></div>
                    </div>
                    ...
                    <div class="info-item">
                        ...
                        <span class="info-value"><?= esc($staff['username']) ?></span>
                    </div>
                    <div class="info-item">
                        <span class="info-label">Hire Date</span>
                        <span class="info-value"><?= date('M d, Y', strtotime($staff['hire_date'])) ?></span>
                    </div>
                    <div class="info-item">
                        <span class="info-label">Account Created</span>
                        <span class="info-value"><?= date('M d, Y', strtotime($staff['created_at'])) ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="profile-card">
                ...
                <div class="card-body">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="username" name="username" 
                                       value="<?= esc($staff['username']) ?>" disabled>
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="role" name="role" 
                                       value="<?= ucfirst(esc($staff['role'])) ?>" disabled>
                            </div>

                            <div class="form-group">
                                <label for="hotel_name" class="form-label">Hotel</label>
                                <input type="text" class="form-control" id="hotel_name" name="hotel_name" 
                                       value="<?= esc($staff['hotel_name']) ?>" disabled>
                            </div>
                        </div>
                    ...
                    <div class="password-section">
                        ...
                        <form action="<?= base_url('staff/profile/change-password') ?>" method="POST">
                            <?= csrf_field() ?>
    ...
    <script>
        ...
        function loadStats() {
            fetch('<?= base_url('staff/profile/stats') ?>')
